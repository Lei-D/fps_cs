...
#' }
#'
fps <- function(S, ndim, covPercent, nsol = 50L, maxnvar = -1L, lambdamin = -1, lambda = as.numeric( c()), maxiter = 100L, tolerance = 1e-3, verbose = 0L) {
    .Call('_fps_fps', PACKAGE = 'fps', S, ndim, covPercent, nsol, maxnvar, lambdamin, lambda, maxiter, tolerance, verbose)
}
